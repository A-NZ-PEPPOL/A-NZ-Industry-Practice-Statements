...
* [Communicating Invoice Status](https://a-nz-peppol.github.io/A-NZ-Industry-Practice-Statements/A-NZ_IPS_Communicating_Invoice_Status.html) (Oct 2020): This document provides guidance for Peppol Service Providers to support their clients in communicating invoice status via the Peppol network. It covers business level response (i.e., Invoice Response Message).
